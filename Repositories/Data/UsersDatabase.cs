...
namespace Mvc.Repositories.Data
{
    public class UsersDatabase : IDisposable
    {
        ...
        {
            _connectionString = Environment.GetEnvironmentVariable("USER_MOVIES_LOCAL_CONNECTION")
                            ?? throw new InvalidOperationException("USER MOVIES DATABASE connection string is missing in environment variables.");
        }
